...
We're a friendly bunch, and happy to chat. You can get in touch with the primary developers to talk about the project using [Signal or Discourse](../contact/contact.md). These are the main community discussion hubs around the dGC project.
