...
For detail on how the WHO reference is implemented - including the move to daily LMS values, the measurement-to-SDS versus SDS-to-measurement asymmetry, and handling of the WHO 2006/2007 five-year boundary - see [WHO Reference Implementation](who-reference-implementation.md).
