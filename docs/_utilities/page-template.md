---
# data in the YAML front matter can be used in the Zensical/MkDocs logic but is not shown on the page
...
# tags add an extra layer of search discoverability - uncomment and reuse the
# controlled vocabulary documented in developer/writing-documentation.md
# tags:
#   - API
#   - Integration
---
